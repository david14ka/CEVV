...
import com.davidkazad.cevv.fragment.ListFragment;
...
public class ListActivity extends BaseActivity {
    ...
    private void initView(int currentTab) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("CEVV"));
        tabLayout.addTab(tabLayout.newTab().setText("JPC Songs"));
        tabLayout.addTab(tabLayout.newTab().setText("ECODIM"));
        tabLayout.addTab(tabLayout.newTab().setText("Orchestre"));
        tabLayout.addTab(tabLayout.newTab().setText("Moissonneur"));
    ...
    public class PagerAdapter1 extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            //int bookId = Book.bookList.get(position).getPid();
